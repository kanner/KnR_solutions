/**
 * Exercise 5-9, page 95
 * Упражнение 5.9, страница 125
 * 
 * Rewrite the routines day_of_year and month_day with pointers instead of
 * indexing.
 *
 * Перепишите функции day_of_year и month_day с применением указателей
 * вместо индексирования массивов.
 */
...
//	for (i = 1; yearday > daytab [leap] [i]; i++)
//		yearday -= daytab [leap] [i];
	for (i = 1; yearday > *(*daytab + leap * MONTH_COUNT + i); i++)
		yearday -= *(*daytab + leap * MONTH_COUNT + i);
