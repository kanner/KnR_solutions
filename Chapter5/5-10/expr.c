/**
 * Exercise 5-10, page 98
 * Упражнение 5.10, страница 129
 * 
 ...
 * evaluates 2 * (3+4).
 *
 * Напишите программу expr, которая бы вычисляла выражение в обратной польской
 * записи из командной строки; каждый операнд и знак операции должен быть
 * отдельным аргументом. Например, следующая командная строка задает вычисление
 * выражения 2 * (3+4):
 * expr 2 3 4 + *
 */
