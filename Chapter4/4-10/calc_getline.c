/**
 * Exercise 4-10, page 68
 * Упражнение 4.10, страница 93
 * 
 * An alternate organization uses getline to read an entire input line; this makes
 * getch and ungetch unnecessary. Revise the calculator to use this approach.
 *
 * В качестве альтернативного подхода можно использовать функцию getline для
 * считывания целых строк. Тогда getch и ungetch становятся ненужными. Перепишите
 * программу-калькулятор с использованием этого подхода.
 */
