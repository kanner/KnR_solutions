 ...
 * Упражнение 4.7, страница 93
 * 
 * Write a routine ungets(s) that will push back an entire string onto the input.
 * Should ungets know about buf and bufp , or should it just use ungetch ?
 *
 * Напишите функцию ungets(s), возвращающую в поток целую строку символов.
 * Следует ли этой функции знать о существовании переменных buf и bufp,
 * или ей достаточно вызывать ungetch?
 */
