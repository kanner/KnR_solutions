/**
 * Exercise 4-6, page 68
 * Упражнение 4.6, страница 92
 * 
 * Add commands for handling variables. (It's easy to provide twenty-six variables
 * with single-letter names.) Add a variable for the most recently printed value.
 *
 * Добавьте команды для работы с переменными (можно использовать 26 различных
 * переменных, если разрешить имена только из одной буквы). Введите переменную,
 * обозначающую последнее выведенное на экран число.
 */
