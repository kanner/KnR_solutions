/**
 * Exercise 4-9, page 68
 * Упражнение 4.9, страница 93
 * 
 ...
 *
 * Наши функции getch и ungetch не могут корректно обработать символ конца файла EOF,
 * возвращенный в поток ввода. Подумайте, как эти функции должны реагировать на EOF
 * в буфере, а затем реализуйте ваш замысел.
 */
